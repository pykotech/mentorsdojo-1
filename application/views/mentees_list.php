...
<h3><i class="icon-user	icon-white"></i>Mentees List<span class="right"><a href="<?php echo site_url('how_it_works'); ?>">How it works</a></span></h3>
<div class="pagination">
<ul class="page-num">
	<li><a href="http://mentorsdojo.com/">Mentors List</a></li>
	<li><a href="http://mentorsdojo.com/mentees_list">Mentees List</a></li>
</ul>
</div>
...
<?php if(isset($profiles))
{
    ...
    <span class="show-prof"><a href="<?php echo site_url('profiles/show') . "/" . $info['mem_id']; ?>">Show Profile</a></span></div>
    <?php
      }
}
